...
def send_email(data):
    """
    Enviar correo de contacto EFICORP ACCOUNTING
    """
    ...
    try:
        ...
        msg.set_content(
            f"""
Nueva consulta recibida (EFICORP ACCOUNTING)
...
Notificacion automatica - EFICORP ACCOUNTING Web
"""
        )
...
<head>
    ...
    <title>Nueva consulta EFICORP ACCOUNTING</title>
</head>
    ...
    <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; margin: 40px auto; background-color: #ffffff; border-radius: 16px; box-shadow: 0 8px 24px rgba(15, 23, 42, 0.12); overflow: hidden;">
        <tr>
            <td style="background: linear-gradient(135deg, #0f172a, #1e3a8a); padding: 36px 24px; text-align: center;">
                <h1 style="color: #ffffff; margin: 0; font-size: 30px; font-weight: 800; letter-spacing: -0.02em;">EFICORP ACCOUNTING</h1>
        ...
        <tr>
            <td style="background-color: #f8fafc; padding: 22px; text-align: center; border-top: 1px solid #e2e8f0;">
                ...
                <p style="color: #94a3b8; font-size: 12px; margin: 0;">&copy; {current_year} EFICORP ACCOUNTING. Todos los derechos reservados.</p>
            </td>
        </tr>
    </table>
